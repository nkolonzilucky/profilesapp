...
export const Display = ({ className }) => {
  return (
    <div
      className={`relative w-[434px] h-[173px] bg-[#2a6b36] rounded-xl overflow-hidden border border-solid border-black shadow-[5px_4px_4px_#000000] ${className}`}
    >
