...
export const SongAndArtist = () => {
  return (
    <div
      className={`relative w-[316px] h-[77px] bg-[#2a6b36] rounded-[var(--shape-corner-extra-large)] overflow-hidden shadow-[2.94px_1.47px_8.82px_1.47px_#313436]`}
    >
