...
export const Title = () => {
  return (
    <div
      className={`inline-flex items-center justify-center gap-2.5 pr-[var(--size-space-300)] pl-[var(--size-space-300)] py-[17px] relative bg-[#2a6b36] rounded-[36.44px] overflow-hidden shadow-[5.21px_5.21px_5.21px_#00000040]`}
    >
